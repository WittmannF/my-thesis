...
\usepackage{graphicx}
\usepackage{wrapfig}
\graphicspath{{imgs/}{imgs/apx/}{imgs/ch1/}{imgs/ch3/}{imgs/ch4/}}
...
\newcommand{\titulo}{NON-INTRUSIVE LOAD MONITORING ALGORITHM USING MIXED-INTEGER LINEAR PROGRAMMING}

\newcommand{\titulobr}{ALGORITMO DE MONITORAMENTO NÃO INTRUSIVO UTILIZANDO PROGRAMAÇÃO LINEAR INTEIRA MISTA}

\newcommand{\orientador}{Marcos J. Rider F.}
...
\begin{document}
    ...
    \input{other/folha-de-aprovacao}
    
    \input{other/dedicatoria}
    
    \input{other/agradecimentos}
    
    \input{other/quote}
    
    \input{other/abstract}
    
    \input{other/notations}
    
    \tableofcontents
    
    \input{chapters/ch1_introduction}
    
    \input{chapters/ch2_fundamentals}
    
    \input{chapters/ch3_math-model}
    
    \input{chapters/ch4_extracting-features}
    
    \input{chapters/ch5_exp-setup}
